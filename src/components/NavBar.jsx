...
const NavBar = () => {
  ...
  return (
    ...
    text-white px-4 bg-black fixed'>
      <div>
      <h1 className='text-4xl font-sign'>Shreesh Nadgir</h1>
      </div>

      <ul className='hidden md:flex'>
        {links.map(({id, link}) => (
           <li key={id} className='px-4 cursor-pointer capitalize hover:bg-gray-900 font-medium text-gray-300 hover:scale-105 duration-200'>
